...
const AvisosLegales = () => {
    return (
        <div id={styles.container}>
            <h1 id={styles.h1}>Avisos <span className='elaGreen'>Legales</span></h1>

            <section className={styles.section}>
                <h3>LEY DE LOS SERVICIOS DE LA SOCIEDAD DE LA INFORMACIÓN (LSSI)</h3>

                <p>ElaDelRevés, S.L., responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.</p>

                <p>Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.</p>

                <p>ElaDelRevés, S.L. se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de ElaDelRevés, S.L</p>
            </section>
            
            <section className={styles.section}>
                <h3>1. DATOS IDENTIFICATIVOS</h3>

                <p><b>● Denominación social</b>: ElaDelRevés, S.L.</p>
                <p><b>● Nombre comercial</b>: ElaDelRevés</p>
                <p><b>● CIF</b>: 1233123145123</p>
                <p><b>● Domicilio</b>: Calle Nueva, 3</p>
                <p><b>● e-mail</b>: eladelreves@gmail.com</p>
            </section>
            ...
            <section className={styles.section}>
                ...
                <p><b>1.</b> Interferencias, interrupciones, fallos, omisiones, averías telefónicas, retrasos, bloqueos o desconexiones en el funcionamiento del sistema electrónico, motivadas por deficiencias, sobrecargas y errores en las líneas y redes de telecomunicaciones, o por cualquier otra causa ajena al control de la empresa. </p>
                <p><b>2.</b> Intromisiones ilegítimas mediante el uso de programas malignos de cualquier tipo y a través de cualquier medio de comunicación, tales como virus informáticos o cualesquiera otros.</p>
                <p><b>3.</b> Abuso indebido o inadecuado del Espacio Web.</p>
                <p><b>4.</b> Errores de seguridad o navegación producidos por un mal funcionamiento del navegador o por el uso de versiones no actualizadas del mismo. El administrador del espacio web se reservan el derecho de retirar, total o parcialmente, cualquier contenido o información presente en el Espacio Web.</p>
